...
| File | Contents |
|---|---|
| [`../README.md`](../README.md) | Quick start, deploy steps, and fixture reference |
| [`OVERVIEW.md`](OVERVIEW.md) | Architecture summary and layout |
| [`../RESPONSIBLE-AI.md`](../RESPONSIBLE-AI.md) | Guardrails, human-in-the-loop, fairness, and stated limitations |
| [`architecture.png`](architecture.png) | Architecture diagram, regenerated by `build_architecture_diagram.py` |
